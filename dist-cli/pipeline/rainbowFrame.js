...
const createBranchAccumulators = (count) =>
...
export const renderRainbowFrame = (input) => {
  ...
  const baseCoupling = input.couplingBase ? { ...input.couplingBase } : { ...coupling };
  ...
  const guardrailEventAccumulator =
  ...
  const applyComposerColor = (value, config) =>
