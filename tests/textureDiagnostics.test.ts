...
const createUniformSurface = (width: number, height: number, value: number): SurfaceField =>
  createSurfaceFromFn(width, height, () => value);

const createStripeSurface = (
  width: number,
  height: number,
  angle: number,
  frequency: number,
